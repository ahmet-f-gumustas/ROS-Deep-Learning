...
(cl:defmethod cl:initialize-instance :after ((m <zaman>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'zaman)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name first_package-msg:<zaman> is deprecated: use first_package-msg:zaman instead.")))

(cl:ensure-generic-function 'stamp-val :lambda-list '(m))
(cl:defmethod stamp-val ((m <zaman>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader first_package-msg:stamp-val is deprecated.  Use first_package-msg:stamp instead.")
  (stamp m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <zaman>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader first_package-msg:data-val is deprecated.  Use first_package-msg:data instead.")
  (data m))
